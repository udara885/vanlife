...
createServer({
    ...
    seeds(server) {
        ...
        server.create("user", { id: "123", email: "test@gmail.com", password: "1234", name: "Udara" })
    },

    routes() {
        this.namespace = "api"
        this.logging = false
        this.timing = 1000  // 1 second delay in server response
        ...
        this.post("/login", (schema, request) => {
            ...
            return {
                user: foundUser,
                token: "Enjoy ,here's your tokens."
            }
        })
    }
})